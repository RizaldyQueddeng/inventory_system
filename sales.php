    ...
    <div class="row-fluid">
      ...
      <div class="span10">
        ...
        <div class="row-fluid content-main">
           ...
           <div class="row-fluid">
             <div class="span8">
               <ul class="nav nav-tabs list">
                ...
                <li><a href="sales_analytics.php">Analytics</a></li>
              </ul>
             </div>
            ...
            <tbody>
              <?php 
                foreach ($sales as $product_sales) {
                  echo "<tr><td>"; 
                  echo $product_sales->id;
                  echo "</td><td>";
                  echo $product_sales->sales_date;
                  echo "</td><td>";
                  echo $product_sales->product;
                  echo "</td><td>";
          ...
          <a href="sales.php" class="btn btn-large left tooltip_dialog" data-toggle="tooltip" data-placement="right" title="Refresh Inventory List"><i class="icon-refresh"></i></a>
                ...
                if ($pagination->total_pages() > 1) {
                  ...
                  for ($i=1; $i <= $pagination->total_pages(); $i++) { 
                    if ($i == $page) {
                      ...
                      echo "<li><a href=\"sales.php?page={$i}\">{$i}</a></li>";
                    }
                  }
